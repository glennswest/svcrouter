...
module.exports = {
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/logthis.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/logthis/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called logthis which is linked to
    //./bin/logthis in the local package.

    //If we have installed this package globally using npm install logthis
    //-g we will be able to call this new command logthis from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/logthis.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/logthis.js"
    }
};
